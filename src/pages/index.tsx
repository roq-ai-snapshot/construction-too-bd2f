...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Construction tool rental v1`}</title>

        <meta
          name="description"
          content="Construction Tool Rental v1 - Your one-stop solution for renting construction tools. A central supplier with multiple outlets, catering to individual customers."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1606676539940-12768ce0e762?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjB0b29sc3xlbnwwfHx8fDE2OTUxNDA2MDF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Construction tool rental v1`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Construction Tool Rental v1 - Your one-stop solution for renting construction tools. A central supplier with multiple outlets, catering to individual customers.`}
            </Text>
            <Box
